...
> **본 프로젝트는 ECCSI-SAKKE(https://github.com/jim-b/ECCSI-SAKKE, Copyright 2015 Jim Buller) 라이브러리를 C++로 포팅·재구조화한 것입니다.  
> 원본을 참고 및 변환하였으며, Apache License 2.0의 조건을 준수합니다.**
...
이 프로젝트는 아래 환경에서 빌드 및 테스트하였습니다.

- **Windows**: Visual Studio 2022 (MSVC, x64)
- **Windows**: MSYS2 MinGW-w64 (GCC 15, x64)
- **Android**: NDK r27 (Clang, arm64-v8a) — 실제 기기에서 RFC 테스트 벡터 검증 완료
...
> ⚠️ **참고:** Windows (MSVC, MinGW)와 Android (NDK arm64-v8a) 환경에서 빌드 및 테스트하였으며,
> 그 외 환경(Linux, iOS)의 프리셋은 참고용으로만 제공합니다.
...
Android용 OpenSSL 정적 라이브러리(arm64-v8a)는 `external/openssl-android-arm64-v8a/`에 배치해야 합니다.
...
- 본 프로젝트는 ECCSI-SAKKE(https://github.com/jim-b/ECCSI-SAKKE, Copyright 2015 Jim Buller) 라이브러리를 C++로 포팅·파생한 것이며, Apache License 2.0의 조건을 따릅니다.
